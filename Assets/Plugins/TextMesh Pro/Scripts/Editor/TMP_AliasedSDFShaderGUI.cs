...
{
    // Why Unity? Why did you put TMP Shader GUI script in UGUI package while shaders themselves are located in TMP folder in Assets?
    
    public class TMP_AliasedSDFShaderGUI : TMP_BaseShaderGUI
    {
        ...
        static TMP_AliasedSDFShaderGUI()
        {
        ...
        void DoFacePanel()
        {
            ...
            DoSlider("_FaceAliasThreshold", "Alias Threshold");
        ...
        void DoOutlinePanel()
        {
            ...
            DoSlider("_OutlineAliasThreshold", "Alias Threshold");
        ...
        void DoUnderlayPanel()
        {
            ...
            else
            {
                ...
                DoSlider("_UnderlayAliasThreshold", "Alias Threshold");
            }
